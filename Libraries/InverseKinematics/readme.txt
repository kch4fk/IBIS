This is a C++ library for Arduino for the IBIS project.
It uses forward kinematics to calculate the position of the arm and camera
based on the positions of the linear actuator and servos.
It is based on an example library created by Nicholas Zambetti for Wiring 0006+

The following relates to basic library installation and building and was
carried over from the Test library example.
